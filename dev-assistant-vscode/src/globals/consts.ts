...
export const BRAND_NAME = "DevAssistant";
...
export const AUTOCOMPLETE_STATE = "AutoComplete State";
...
export const PROJECT_OPEN_GITHUB_COMMAND = "DevAssistant::openGithub";
...
export const OUTPUT_CHANNEL_NAME = "DevAssistant";