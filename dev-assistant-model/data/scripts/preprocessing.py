...
import numpy as np
from scripts.arguments import PreprocessingArguments
from datasets import load_dataset,load_from_disk
from scripts.minhash_deduplication import deduplicate_dataset
...
def clean_dataset(args_dict,save_to_disk=False):
    # Settings
    ...
    t_start = time.time()
    # for huge dataset we can't save it in one file
    ...
    if save_to_disk:
        ds_filter.save_to_disk(output_dir)
    print(f"Time to clean dataset: {time.time()-t_start:.2f}")
    return ds_filter
