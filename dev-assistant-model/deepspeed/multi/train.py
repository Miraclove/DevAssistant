...
from dialogues import get_dialogue_template, mask_user_labels, prepare_data
...
def main():
    ...
    raw_datasets = raw_datasets.map(prepare_data, fn_kwargs={"dialogue_template": dialogue_template})
    ...
    # save final model
    import os
    path = training_args.output_dir + '/final_model'
